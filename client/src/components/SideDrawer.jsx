...
import { Tooltip, Box, Text, Button, MenuButton, Menu, MenuList, Avatar, MenuDivider, MenuItem, DrawerOverlay, Drawer, DrawerHeader, DrawerContent, Input, DrawerBody,} from "@chakra-ui/react";
...
const SideDrawer = () => {
  ...
  const handleSearch = async () => {
    if (!search) { return toast.info("Please enter a query");}
    setLoading(true);
    try {
      const config = {
        headers: {
